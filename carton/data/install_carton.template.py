...
# became the real bootstrap while ``bootstrap/carton_bootstrap.py`` —
# the one the test suite exercises — was never shipped. The staged-update
# sha256 re-verification lived only in the tested copy and therefore
# protected nobody. One source, substituted at build time, is the only
# arrangement where "tested" and "shipped" cannot drift apart.
USERSETUP_HOOK = __USERSETUP_HOOK_LITERAL__

BOOTSTRAP_PY = __BOOTSTRAP_PY_LITERAL__
