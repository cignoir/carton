...
_STRINGS = {
    "en": {
        ...
        "register": "Register",
        "relink": "Relink",
        "relink_tooltip": "The registered source is missing:\n{}\nPick its new location.",
        "relink_pick_folder": "Select the folder this tool now lives in",
        "relink_pick_file": "Select the file this tool now lives in",
        "relink_wrong_kind_folder": "This package was registered as a folder. Pick a folder, not a file.",
        "relink_wrong_kind_file": "This package was registered as a single file. Pick a file, not a folder.",
        "relink_done": "Relinked to:\n{}",
        "source_missing_badge": "Source missing",
        "source_missing_tooltip": "Registered path no longer exists:\n{}",
        "remove": "Remove",
        "install": "Install",
        ...
        "publish_version_taken": "v{} is already published to this catalogue.",
        "publish_bump_prompt": "Publish as {} instead?",
        "publish_bump_confirm": "Publish as {}",
        "publish_bump_failed": "Could not record the new version — the package is no longer registered.",
        ...
        "add_no_namespace": "Please enter a namespace (e.g. mystudio). The namespace declares who owns this package — Carton does not auto-stamp it.",
        ...
        "settings_default_namespace": "Default namespace",
        "settings_default_namespace_placeholder": "e.g. mystudio",
        "settings_default_namespace_hint": "Prefilled when you register a tool. Publishing requires a namespace, so setting it once here saves typing it every time.",
    ...
    "ja": {
        ...
        "register": "登録",
        "relink": "再リンク",
        "relink_tooltip": "登録されたソースが見つかりません:\n{}\n新しい場所を指定してください。",
        "relink_pick_folder": "このツールの現在のフォルダを選択",
        "relink_pick_file": "このツールの現在のファイルを選択",
        "relink_wrong_kind_folder": "このパッケージはフォルダとして登録されています。ファイルではなくフォルダを選択してください。",
        "relink_wrong_kind_file": "このパッケージは単体ファイルとして登録されています。フォルダではなくファイルを選択してください。",
        "relink_done": "再リンクしました:\n{}",
        "source_missing_badge": "ソース消失",
        "source_missing_tooltip": "登録されたパスが存在しません:\n{}",
        "remove": "削除",
        "install": "インストール",
        "installing": "インストール中...",
        "uninstall": "アンインストール",
        ...
        "publish_version_taken": "v{} はこのカタログに公開済みです。",
        "publish_bump_prompt": "代わりに {} として publish しますか？",
        "publish_bump_confirm": "{} として publish",
        "publish_bump_failed": "新しいバージョンを記録できませんでした — パッケージの登録が見つかりません。",
        ...
        "add_no_namespace": "namespace を入力してください（例: mystudio）。namespace はパッケージの所有者を宣言するもので、Carton が自動で付与することはありません。",
        ...
        "settings_default_namespace": "デフォルト namespace",
        "settings_default_namespace_placeholder": "例: mystudio",
        "settings_default_namespace_hint": "ツール登録時に自動入力されます。publish には namespace が必須なので、ここで一度設定しておけば毎回入力せずに済みます。",
