...
_STRINGS = {
    "en": {
        ...
        "publish_remote_sync_reminder": "Remember to upload the registry files to '{}' so others can install this update.",
        ...
        "publish_no_remote_id": "Remote '{}' does not expose a registry_id, so Carton cannot pair it with a local mirror. Stamp the remote registry.json first (e.g. `python -m carton registry id ... --stamp`) and re-upload.",
        "publish_create_mirror": "Create new mirror",
        "publish_pair_existing": "Pair with existing registry",
        ...
        "origin_verified_badge": "Verified source",
        ...
        "origin_unverified_badge": "Unverified source",
        "origin_unverified_tooltip": "No pinned SHA256 (e.g. GitHub auto-generated archive). The first download is trusted and its hash is remembered, but the original bytes are not authoritatively signed. Enable Strict Verify to refuse these entirely.",
        ...
        "publish_embed_source_path_tooltip": "Stamps the absolute source path into the published package so reinstalling Carton on the same machine restores your My Tools entry automatically. Uncheck for public registries — the path leaks your directory layout.",
        ...
        "settings_github_pkg_registered": "Added single package '{}' to your personal catalogue.",
        "settings_github_pkg_already_added": "'{}' is already in your personal catalogue.",
        ...
        "registry_stamp_prompt": "This registry has no registry_id yet. Stamp a fresh UUID into the file? (Needed to detect duplicates and route publishes through its remote mirrors.)",
        "registry_duplicate_title": "Registry already registered",
        "registry_duplicate_msg": "This registry is already registered as '{}' ({}).\nUse the existing entry, or add this as a separate alias?",
    ...
    "ja": {
        ...
        "publish_remote_sync_reminder": "このアップデートを他の人が取得できるようにするには、'{}' にレジストリをアップロードし直してください。",
        ...
        "publish_no_remote_id": "リモート '{}' は registry_id を持っていないので、ローカルミラーと紐付けられません。先に `python -m carton registry id ... --stamp` 等でリモート側を stamp してからアップロードし直してください。",
        "publish_create_mirror": "ミラーを新規作成",
        "publish_pair_existing": "既存レジストリとペアリング",
        ...
        "origin_verified_badge": "検証済ソース",
        "origin_verified_tooltip": "アーティファクトの SHA256 がカタログまたは Release の SHA256SUMS に明示記録されています — ダウンロードのたびに同じ正規ハッシュで検証されます。",
        "origin_unverified_badge": "未検証ソース",
        "origin_unverified_tooltip": "SHA256 が明示記録されていません（例: GitHub 自動生成 archive）。初回ダウンロードは信頼し、ハッシュを記憶しますが、元バイトは正規署名されていません。完全に拒否したい場合は「厳密検証」を有効化してください。",
        ...
        "publish_embed_source_path_tooltip": "公開パッケージに絶対パスを埋め込み、同じマシンで Carton を再インストールした際に My Tools エントリを自動復元します。公開レジストリでは無効化してください（ディレクトリ構成が漏れます）。",
        ...
        "settings_github_pkg_registered": "単品パッケージ '{}' を個人カタログに追加しました。",
        "settings_github_pkg_already_added": "'{}' は既に個人カタログに追加されています。",
        ...
        "registry_stamp_prompt": "このレジストリには registry_id がまだ付いていません。新しい UUID をファイルに stamp しますか？（重複検出とリモートミラー経由の公開に必要です）",
        "registry_duplicate_title": "レジストリは登録済みです",
        "registry_duplicate_msg": "このレジストリは '{}' ({}) として既に登録済みです。\n既存エントリを使いますか？それとも別名として追加しますか？",
